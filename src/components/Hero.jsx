  ...
  return (
    <div className={`sm:min-h-screen ${light ? 'bg-white text-black' : 'bg-black text-white'} h-[80vh] flex items-center relative `}>
      <div data-aos="zoom-out" data-aos-duration='1500'>
        <h1 className="sm:text-9xl text-[4rem] font-bold mb-4  px-6">
          Creative  <br /> <span   className="italic sm:px-[30%] px-[18%] text-[#14CF93] font-[MAZIUS]">  Frontend </span> <br />{" "}
          Developer
        </h1>
      </div>
      <div className="flex gap-10 px-1 absolute bottom-14 left-5 sm:top-52 sm:left-[65%]" data-aos="zoom-out" data-aos-duration='1500'>
